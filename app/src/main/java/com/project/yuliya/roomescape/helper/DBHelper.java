package com.project.yuliya.roomescape.helper;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + dbKeys.TABLE + "("
                ...
                + dbKeys.KEY_USER_FACEBOOK_ID + " String,"
    ...
    public int saveNewUser(int globalId,String facebookId, String UserName) {
        ...
        try {
            ...
            if (database != null) {
                ...
                contentValues.put(dbKeys.KEY_USER_FACEBOOK_ID,String.valueOf(facebookId));
    ...
    public User getUserFacebook(String facebookId) {
        ...
        try {
            ...
            if (database != null) {
                ...
                cursor = database.query(dbKeys.TABLE, null,
                        dbKeys.KEY_USER_FACEBOOK_ID + " = ?", new String[]{facebookId},
                        null, null, null);
                ...
                if(currentUser!=null)
                    changeCurrentUser(currentUser.getLocalId());
                ...
                if (cursor.moveToFirst()) {
                    ...
                    do {
                        Log.d(dbKeys.TAG, "localId = " + cursor.getInt(cursor.getColumnIndex(dbKeys.KEY_ID)) +
                                ...
                                ", facebookId = " + cursor.getString(cursor.getColumnIndex(dbKeys.KEY_USER_FACEBOOK_ID))+
